...
function Send() {
    ...
    const B = ["hello","world"];
    let result = B.some((el) => sQuestion.includes(el))
    if (result === true){
        alert("JHJHH");
        txtMsg.focus();
        return;
    ...
    //}
     //else if (sQuestion.includes("world")){
       // alert("WOWza");
        //txtMsg.focus();
        //return;
     //}
    ...
    oHttp.setRequestHeader("Authorization", "Bearer " + "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");
